...
import styles from "./jee-adv.module.css";

const JeeAdv = () => {
  return (
    <div className={styles.jeeAdv}>
      <div className={styles.jeeMainPageContent}>
        <div className={styles.rankMatrix}>
          ...
          <div
            ...
            src="/vector.svg"
          />
          <b className={styles.jeeAdvanced}>JEE Advanced</b>
          ...
          <b className={styles.jeeAdvancedRank}>JEE Advanced Rank</b>
